...
const Drawer = () => {
    ...
    return (
        <div onClick={toggleDrawerHandler} className={classes.drawer + ` ${toggleDrawer ? "" : classes.toggledrawer}`}>
            <div className={classes.drawer_actions + ` ${toggleDrawer ? classes.add_radius : ''}`}>
                <div>
                    <div className={`${toggleDrawer ? "" : classes.icon_wrapper}`}>
            ...
            <div className={classes.info + ` ${toggleDrawer ? "" : classes.hideInfo}`}>
                <a href='https://ssl.gstatic.com/keep/licenses/web_client_licenses.txt'>Open-source License</a>
            </div>
        </div>
    )
}
